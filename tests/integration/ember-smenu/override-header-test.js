...
moduleForComponent(
  '/ember-smenu', 'Integration | ember-smenu | custom header', {
  integration: true,
  beforeEach: function() {
...
function getTemplate() {
  return hbs`
    {{#ember-smenu data=basicData path=path
      ...
      {{#esm-header as |current selectHeader close|}}
        {{#if current.prev}}
          <div class="menu-header-close" {{action close}} >
            &lt;
          </div>
        {{/if}}
        <div class="menu-header-label" {{action selectHeader}} >
